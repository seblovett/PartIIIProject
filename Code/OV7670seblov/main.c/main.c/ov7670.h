 ...
 *		- Picture cannot currently be stored, only passed on - hope to implement using sn SD card on the Il Matto Board.
...
uint8_t GetImageIfAvailiable(void);				//Gets all pixel data if available
