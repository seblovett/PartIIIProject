...
In order to reduce the risk within the project, all aspects of potential issues are looked at and are summarised in table \ref{tab:risk}. A Gannt chart of how time will be spent can be seen in figure \ref{fig:Gannt}. 
