...
\begin{figure}
\centering
\subfigure[Left Image]{\includegraphics[width=\textwidth/2-1cm,keepaspectratio]{./Figures/deskLeft.png} }
\subfigure[Right Image]{\includegraphics[width=\textwidth/2-1cm,keepaspectratio]{./Figures/deskRight.png} }
