...
By using two images separated by a horizontal distance, $B$, the range of an object can be found given some characteristics of the camera. The following are a derivations of the equations used to calculate distance. 
