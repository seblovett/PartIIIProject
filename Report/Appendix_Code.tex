...
\lstinputlisting[style=matlab,frame=single,numbers=left,tabsize=2,breaklines=true]{../MATLAB/Match.m}

\subsubsection{MatchAll.m}
\lstinputlisting[style=matlab,frame=single,numbers=left,tabsize=2,breaklines=true]{../MATLAB/MatchAll.m}
%
