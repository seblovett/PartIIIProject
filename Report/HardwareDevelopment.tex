...
\subsection{Motor Driving Development}

\subsection{PCB Circuit Development}
As discussed in \ref{Research:Microcontroller}, a AT32UC3C is going to be used. The Atmel UC3-EK provided a base template to develop the circuit on as this has a SD card and SRAM on it and code is provided for using these devices. 
\begin{figure}
