...
\lstinputlisting[style=C,caption=UART Test Code,label={lst:UARTTestCode},frame=single,numbers=left,tabsize=2,breaklines=true, firstline=124,lastline=196]{../Code/ColumbusTest/ColumbusTest/src/main.c}
...
\subsubsection{Motor Driver Footprint incorrect}
\inote{Rev B of the PCB / list of problems}
\inote{Given more time, different}
\inote{silk screen for components to avoid incorrect placement}
\subsection{PCB Conclusions}
\section{Conclusions}
\inote{Overall Conclusions of the Hardware design}
\begin{figure}
\centering
\subfigure[Top View of built PCB\label{fg:PCB:Top}]{\includegraphics[width = \textwidth, keepaspectratio]{./Figures/PCB_Top.jpg} }
\subfigure[Bottom View of built PCB\label{fg:PCB:Bottom}]{\includegraphics[width = \textwidth, keepaspectratio]{./Figures/PCB_Bottom.jpg} }
\caption{Pictures of the PCB built. SDRAM Chip Select problem patch can be seen in figure \ref{fg:PCB:Bottom}}.
\label{fig:PCB:Built}
\end{figure}
