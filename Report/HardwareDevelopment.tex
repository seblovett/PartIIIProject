...
The entire prototype for the dual camera operation can be seen in figure \ref{fig:Prototype}. This circuit was developed to test the cameras and is used to develop the PCB in section \ref{Section:PCB_Dev}. Another prototype was also made to stream the camera images to a TFT screen. This helped with with testing cameras and focusing them. Figure \ref{fig:Prototype:TFT} shows the set up during operation.
